...
configuration needed. Nix's own string delimiters (`"`, `''`) are
deliberately excluded even though they're leaves too -- `tree-sitter-nix`
tags both `@string`, so they're already prose, exempt from this setting in
