--- The main parser for the `:TreeMotion arbitrary-thing` command.

local cmdparse = require("mega.cmdparse")

local M = {}

---@return mega.cmdparse.ParameterParser # The main parser for the `:TreeMotion arbitrary-thing` command.
function M.make_parser()
    ...
    parser:set_execute(function(data)
        ...
        local runner = require("treemotion._commands.arbitrary_thing.runner")
