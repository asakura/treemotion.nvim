--- The file that auto-creates documentation for `treemotion`.
...
local function main()
    ...
    vimdoc.make_documentation_files({
        {
            source = vim.fs.joinpath(root, "lua", "treemotion", "init.lua"),
            destination = vim.fs.joinpath(root, "doc", "treemotion_api.txt"),
        },
        {
            source = vim.fs.joinpath(root, "lua", "treemotion", "types.lua"),
            destination = vim.fs.joinpath(root, "doc", "treemotion_types.txt"),
        },
